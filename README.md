...
[jeeflow](https://github.com/mldong/jeeflow-spec) 引擎规范的 **Go 语言实现**，零外部依赖，纯 stdlib。
...
对齐 [jeeflow-spec](https://github.com/mldong/jeeflow-spec) v1.0，与 Java 版共享同一套流程 JSON 文件驱动测试。
